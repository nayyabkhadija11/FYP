...
class VaccinationStatusHelper {
  ...
  /// (e.g. "August 2026"). Used by the Reports screen so Monthly Report
  /// numbers are calculated the same live way as the Dashboard, instead of
  /// relying on a literal 'status' field that never gets written for
  /// missed doses.
