...
class _VaccinationEntryScreenState extends State<VaccinationEntryScreen> {
  ...
  String _calculateNextDueVaccine(String currentVaccine) {
    switch (currentVaccine) {
      case "BCG":
      case "OPV 0":
        return "OPV 1 / Pentavalent 1";
      case "OPV 1 / Pentavalent 1":
        return "OPV 2 / Pentavalent 2";
      case "OPV 2 / Pentavalent 2":
        return "OPV 3 / Pentavalent 3";
      case "OPV 3 / Pentavalent 3":
        return "Measles 1";
      case "Measles 1":
        return "Measles 2";
      case "Measles 2":
        return "Polio Booster Dose";
      default:
  ...
  Future<void> _saveVaccinationRecord() async {
    ...
    try {
      ...
      if (_status == 'Missed') mappedStatus = 'missed';
      ...
      Map<String, dynamic> childUpdate = {
        ...
        'status': mappedStatus == 'vaccinated' ? 'Vaccinated' : (_status == 'Refused' ? 'Refused' : 'Missed'),
