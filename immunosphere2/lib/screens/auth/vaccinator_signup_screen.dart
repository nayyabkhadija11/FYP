...
class VaccinatorSignUpScreen extends StatefulWidget {
  const VaccinatorSignUpScreen({Key? key}) : super(key: key);

  @override
  State<VaccinatorSignUpScreen> createState() => _VaccinatorSignUpScreenState();
}

class _VaccinatorSignUpScreenState extends State<VaccinatorSignUpScreen> {
      ...
      body: SingleChildScrollView(
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              const Center(child: Text('Vaccinator Registration', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold))),
